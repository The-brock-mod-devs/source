...
public class ContainerBrockFurnace extends Container
{
    ...
    public ContainerBrockFurnace(InventoryPlayer par1InventoryPlayer, TileEntityBrockFurnace par2TileEntityFurnace)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (MyLittlePony.getSmeltingResult(0, itemstack1) != null)
                {
